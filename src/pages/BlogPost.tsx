  ...
  return (
    <main className="min-h-screen bg-sky-50 pb-16">
      ...
      <article itemScope itemType="https://schema.org/BlogPosting">
        {/* Hero Banner */}
        <header className="relative w-full h-[40vh] min-h-[300px] sm:h-[50vh] xl:h-[60vh] overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-0 top-0 flex items-center justify-center z-20 p-4">
            <div className="max-w-4xl mx-auto w-full">
              ...
              >
                ...
                <h1 itemProp="headline" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight drop-shadow-lg mb-4">
                  {post.title}
                </h1>
                <div className="flex flex-wrap items-center gap-4 text-white/90 text-sm sm:text-base font-medium drop-shadow-md">
                  ...
                  <span itemProp="author" itemScope itemType="https://schema.org/Person" className="flex items-center gap-1.5">
                    ...
                    Por <span itemProp="name">{post.author}</span>
                  </span>
                </div>
              </motion.div>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 -mt-10 sm:-mt-16 relative z-30">
          ...
          >
            <div itemProp="articleBody" className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:text-slate-800 prose-h3:text-sky-600 prose-p:text-slate-600 prose-p:leading-relaxed prose-a:text-sky-500 hover:prose-a:text-sky-600 prose-strong:text-slate-700">
              <ReactMarkdown>
                {post.content}
              </ReactMarkdown>
            </div>
            ...
            <div className="bg-sky-50/50 rounded-2xl p-6 text-center border border-sky-100">
              ...
              <button
                onClick={() => {
                  const navBtn = document.getElementById('btn-donar-header');
